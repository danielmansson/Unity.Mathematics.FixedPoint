...
{
    [TestFixture]
    public class TestFp4x3
    {
        public static void fp4x3_zero()
        {
            TestUtils.AreEqual(fp4x3.zero.c0.x, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c0.y, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c0.z, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c0.w, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c1.x, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c1.y, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c1.z, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c1.w, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c2.x, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c2.y, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c2.z, (fp)0);
            TestUtils.AreEqual(fp4x3.zero.c2.w, (fp)0);
        }
