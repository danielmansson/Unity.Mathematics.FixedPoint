...
namespace Unity.Mathematics.Tests
{
    class TestUtils
    {
        ...
        public static void AreEqual(fp a, fp b, fp delta = default(fp))
        {
        ...
        // fp
        public static void AreEqual(fp2 a, fp2 b, fp delta = default(fp))
        {
            AreEqual(a.x, b.x, delta);
            AreEqual(a.y, b.y, delta);
        }
        ...
        public static void AreEqual(fp3 a, fp3 b, fp delta = default(fp))
        {
            AreEqual(a.x, b.x, delta);
            AreEqual(a.y, b.y, delta);
            AreEqual(a.z, b.z, delta);
        ...
        public static void AreEqual(fp4 a, fp4 b, fp delta = default(fp))
        {
            AreEqual(a.x, b.x, delta);
            AreEqual(a.y, b.y, delta);
            AreEqual(a.z, b.z, delta);
        ...
        public static void AreEqual(fp2x2 a, fp2x2 b, fp delta = default(fp))
        {
            AreEqual(a.c0, b.c0, delta);
            AreEqual(a.c1, b.c1, delta);
        }
        ...
        public static void AreEqual(fp3x2 a, fp3x2 b, fp delta = default(fp))
        {
            AreEqual(a.c0, b.c0, delta);
            AreEqual(a.c1, b.c1, delta);
        }
        ...
        public static void AreEqual(fp4x2 a, fp4x2 b, fp delta = default(fp))
        {
            AreEqual(a.c0, b.c0, delta);
            AreEqual(a.c1, b.c1, delta);
        }
        ...
        public static void AreEqual(fp2x3 a, fp2x3 b, fp delta = default(fp))
        {
            AreEqual(a.c0, b.c0, delta);
            AreEqual(a.c1, b.c1, delta);
            AreEqual(a.c2, b.c2, delta);
        ...
        public static void AreEqual(fp3x3 a, fp3x3 b, fp delta = default(fp))
        {
            AreEqual(a.c0, b.c0, delta);
            AreEqual(a.c1, b.c1, delta);
            AreEqual(a.c2, b.c2, delta);
        ...
        public static void AreEqual(fp4x3 a, fp4x3 b, fp delta = default(fp))
        {
            AreEqual(a.c0, b.c0, delta);
            AreEqual(a.c1, b.c1, delta);
            AreEqual(a.c2, b.c2, delta);
        ...
        public static void AreEqual(fp2x4 a, fp2x4 b, fp delta = default(fp))
        {
            AreEqual(a.c0, b.c0, delta);
            AreEqual(a.c1, b.c1, delta);
            AreEqual(a.c2, b.c2, delta);
        ...
        public static void AreEqual(fp3x4 a, fp3x4 b, fp delta = default(fp))
        {
            AreEqual(a.c0, b.c0, delta);
            AreEqual(a.c1, b.c1, delta);
            AreEqual(a.c2, b.c2, delta);
        ...
        public static void AreEqual(fp4x4 a, fp4x4 b, fp delta = default(fp))
        {
            AreEqual(a.c0, b.c0, delta);
            AreEqual(a.c1, b.c1, delta);
            AreEqual(a.c2, b.c2, delta);
